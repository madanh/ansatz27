...
classdef JSON_Parser < JSON
    ...
    methods (Access=private)
        ...
        function str = parseStr(this)
            ...
            str = '';
            if this.json(this.pos)=='"'
                % This early return for a common case of an empty string was
                % inserted to assure roundtripping. Otherwise the logic in the
                % main loop results in 1x0 char arrays instead of 0x0 char
                % arrays that are generated by '' literal in matlab
                this.pos = this.pos + 1;    
                return
            end
            closed = false;
            ...
            while this.pos <= this.len
                ...
                if this.index_esc > this.len_esc
                    ...
                    % TODO: This likely leads to 1x0 char instead of 0x0. 
                    % Investigate, if true, fix and remove special case 
